...
class DWConv(nn.Module):#deep-wise conv
...
class MiT(nn.Module):
    def __init__(self, image_size, dims, layers, token_mlp='mix_skip'):# here image_size = 224, dims = [64, 128, 320, 512], layers = [2, 2, 2, 2]
        super().__init__()
        patch_sizes = [7, 3, 3, 3]#why the patch set like this?
        strides = [4, 2, 2, 2]
