...
if __name__ == "__main__":
    ...
    model = MSTransception(num_classes=9, head_count=8, dil_conv = 1, token_mlp_mode="mix_skip",MSViT_config=2, concat='coord', have_bridge = 'para', Stage_3or4=3, br_ch_att_list = [False, True, False, False])
