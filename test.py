...
parser.add_argument('--is_savenii', type=bool, default=False, help="True, then the prediction can be saved")
...
parser.add_argument('--have_bridge', type=str,
                    default='None', help='None: no bridge; new:new bridge; original: original bridge')
...
if __name__ == "__main__":
    ...
    snapshot = f'/work/scratch/yiwei/reproduce/MSTr_4stage_cbam_cos/log2/MSTr_4stage_cbam_cos_8122_epoch_409.pth'
...
#  python test.py --dataset Synapse --base_lr 0.05 --max_epochs 500 --model_name MSTr_4stage_skn --dil_conv=1 --output_dir /work/scratch/yiwei/reproduce/MSTr_4stage_cbam_cos/log2 --head_count 8 --concat cbam --have_bridge None --Stage_3or4 4 --use_sa_config 5