...
parser.add_argument('--volume_path', type=str,
                    default= '/images/PublicDataset/Transunet_synaps/project_TransUNet/data/Synapse/', help='root dir for validation volume data')  # for acdc volume_path=root_dir
...
if __name__ == "__main__":
    ...
    snapshot = f'/home/students/yiwei/yiwei_gitlab/EffFormer/model_out/Transception_v3_epoch_499.pth'
    if not os.path.exists(snapshot): snapshot = snapshot.replace('best_model', 'epoch_'+str(args.max_epochs-1)+"_wo_bridge")
    msg = net.load_state_dict(torch.load(snapshot))
    print("self trained EffMISSFormer",msg)
